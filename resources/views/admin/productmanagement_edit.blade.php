            ...
            <div id="manage_border" class="card-body">
                <form action="{{URL('admin/updateproduct/'.$product->id)}}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group mb-3" id="add">
                        ...
                        <input type="text" name="product_name" id="input-area" value="{{$product->product_name}}">
                    </div>
                    <!-- addimg -->
                        ...
                        <div id="addimg">
                            ...
                            <div id="btnreal">
                                <img src="{{ asset('images_product/'.$product->product_image->first()->name) }}"
                                    alt="{{$product->product_image->first()->name}}" width="150px">
                    ...
                    <div class="form-group mb-3" id="add">
                        ...
                        <input type="number" name="product_stock" id="input-area" value="{{$product->product_stock}}">
                    </div>
                    <div class="form-group mb-3" id="add">
                        <label for="product_price">ราคา:</label>
                        <input type="text" name="product_price" id="input-area" value="{{$product->product_price}}">
                    </div>
                    <div class="form-group mb-3" id="add">
                        <label for="product_cost">ต้นทุน:</label>
                        <input type="text" name="product_cost" id="input-area" value="{{$product->product_cost}}">
                    </div>
                    <div class="form-group mb-3" id="add">
                        <label for="product_detail">ข้อมูลสินค้า:</label>
                        <textarea name="product_detail" id="textarea" cols="30" rows="7"
                            style="resize: none;">{{$product->product_detail}}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="promotion_discount" id="" value="{{$product->product_discount}}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="promotion_start">ส่วนลด:</label>
                        <input type="date" name="promotion_start" id="" value="{{$product->product_start}}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="promotion_end">ส่วนลด:</label>
                        <input type="date" name="promotion_end" id="" value="{{$product->product_end}}">
                    </div>
