<link href="/css/admin/navadmin.css" rel="stylesheet">
...
<nav id="sidebar">
    ...
    <div id="menu-bar">
        <div id="menu">
            <ul id="menu-links">
                <li id="nav-link">
                    <a href="{{route('dashboard')}}" class="" id="menubtn">
                        <i class='bx bxs-dashboard' id="icon"></i>
                        <span id="text nav-text">แดชบอร์ด</span>
                    </a>
                </li>
                <li id="nav-link">
                    <a href="{{route('productmanage')}}" class="" id="menubtn">
                        <i class='bx bx-grid-alt' id="icon"></i>
                        <span id="text nav-text">จัดการสินค้า</span>
                    </a>
                </li>
                <li id="nav-link">
                    <a href="{{route('categorymanage')}}" class="" id="menubtn">
